...
class _EquipamientoState extends State<Equipamiento> {
  Refrigerador _refrigerador;
  RefrigeradorSirve _refrigeradorSirve;
  Estufa _estufa;
  EstufaSirve _estufaSirve;
  Video _video;
  VideoSirve _videoSirve;
  Lavadora _lavadora;
  LavadoraSirve _lavadoraSirve;
  Licuadora _licuadora;
  LicuadoraSirve _licuadoraSirve;
  Television _television;
  TelevisionSirve _televisonSirve;
  RadioE _radio;
  RadioSirve _radioSirve;
  Sala _sala;
  SalaSirve _salaSirve;
  Comedor _comedor;
  ComedorSirve _comedorSirve;
  Automovil _automovil;
  AutomovilSirve _automovilSirve;
  Cama _cama;
  CamaSirve _camaSirve;
  Celular _celular;
  CelularSirve _celularSirve;
  Motocicleta _motocicleta;
  MotocicletaSirve _motocicletaSirve;
  Computadora _computadora;
  ComputadoraSirve _computadoraSirve;
  Horno _horno;
  HornoSirve _hornoSirve;
  Telefono _telefono;
  TelefonoSirve _telefonoSirve;
