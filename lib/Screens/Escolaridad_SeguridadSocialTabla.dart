...
//Variables del renglon 8
  ...
  renglon1() async {
    if (_nombre1.text != '') {
      ...
      EscolaridadSeguridadSocial DModel11 = EscolaridadSeguridadSocial(
          ...
          txt_desc_prestacioneslab: presta1.trimLeft(),
  ...
  renglon2() async {
    if (_nombre2.text != '') {
      ...
      EscolaridadSeguridadSocial DModel2 = EscolaridadSeguridadSocial(
          ...
          txt_desc_prestacioneslab: presta2,
  ...
  renglon3() async {
    if (_nombre3.text != '') {
      ...
      EscolaridadSeguridadSocial DModel3 = EscolaridadSeguridadSocial(
          ...
          txt_desc_prestacioneslab: presta3,
  ...
  renglon4() async {
    if (_nombre4.text != '') {
      ...
      EscolaridadSeguridadSocial DModel4 = EscolaridadSeguridadSocial(
          ...
          txt_desc_prestacioneslab: presta4,
  ...
  renglon5() async {
    if (_nombre5.text != '') {
      ...
      EscolaridadSeguridadSocial DModel5 = EscolaridadSeguridadSocial(
          ...
          txt_desc_prestacioneslab: presta5,
  ...
  renglon6() async {
    if (_nombre6.text != '') {
      ...
      EscolaridadSeguridadSocial DModel6 = EscolaridadSeguridadSocial(
          ...
          txt_desc_prestacioneslab: presta6,
  ...
  renglon7() async {
    if (_nombre7.text != '') {
      ...
      EscolaridadSeguridadSocial DModel7 = EscolaridadSeguridadSocial(
          ...
          txt_desc_prestacioneslab: presta7,
  ...
  renglon8() async {
    if (_nombre8.text != '') {
      ...
      EscolaridadSeguridadSocial DModel8 = EscolaridadSeguridadSocial(
          ...
          txt_desc_prestacioneslab: presta8,
  ...
  renglon9() async {
    if (_nombre9.text != '') {
      ...
      EscolaridadSeguridadSocial DModel9 = EscolaridadSeguridadSocial(
          ...
          txt_desc_prestacioneslab: presta9,
  ...
  renglon10() async {
    if (_nombre10.text != '') {
      ...
      EscolaridadSeguridadSocial DModel10 = EscolaridadSeguridadSocial(
          ...
          txt_desc_prestacioneslab: presta10,
  ...
  void guardar() async {
    ...
    try {
      ...
      alertDialog(context, 'Datos guardos con Exito');
      Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(
            builder: (_) => Salud_PertenenciaIndigenaTabla(
                folio: widget.folio,
                dispositivo: widget.dispositivo,
                folioDisp: widget.folioDisp,
                usuario: widget.usuario)),
