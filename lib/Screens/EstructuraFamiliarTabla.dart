...
class _EstructuraFamiliarTablaState extends State<EstructuraFamiliarTabla> {
  ...
  renglon1() async {
    if (_nombre1.text != '') {
      ...
      await metodos(
          _entidadNacimiento1.text, _estadoCivil1.text, _parentesco1.text);

      var EstadoCivil = _estadoCivil1.text.toString();
      final estadoCivil = rpn.replaceNum(EstadoCivil);
      var Parentesco = _parentesco1.text.toString();
      final parentesco = rpn.replaceNum(Parentesco);
      var EntidadN = _entidadNacimiento1.text.toString();
      ...
      EstructuraFamilarModel ef = EstructuraFamilarModel(
          ...
          claveEntidad: _entidadNacimiento1.text.substring(0, 2).trimRight(),
          entidadNacimiento: entidadNacimiento.toString().trimLeft(),
          curp: _curp1.text.toString(),
          claveEstadoCivil: _estadoCivil1.text.substring(0, 2).trimRight(),
          ordenEstadoCivil: _EstadosCiviles2.map((e) => e.Orden).first,
          estadoCivil: estadoCivil.toString().trimLeft(),
          claveParentesco: _parentesco1.text.substring(0, 2),
          ordenParentesco: _Parentesco2.map((e) => e.Orden).first,
          parentesco: parentesco.toString().trimLeft(),
          otroEstadoCivil: _otroEstadoCivil1.text.toString(),
  ...
  renglon2() async {
    if (_nombre2.text != '') {
      ...
      await metodos(
          _entidadNacimiento2.text, _estadoCivil2.text, _parentesco2.text);

      var EstadoCivil = _estadoCivil2.text.toString();
      final estadoCivil = rpn.replaceNum(EstadoCivil);
      var Parentesco = _parentesco2.text.toString();
      final parentesco = rpn.replaceNum(Parentesco);
      var EntidadN = _entidadNacimiento2.text.toString();
      final entidadNacimiento = rpn.replaceNum(EntidadN);
      ...
      EstructuraFamilarModel ef = EstructuraFamilarModel(
          ...
          claveEntidad: _entidadNacimiento2.text.substring(0, 2).trimRight(),
          entidadNacimiento: entidadNacimiento.toString().trimLeft(),
          curp: _curp2.text.toString(),
          claveEstadoCivil: _estadoCivil2.text.substring(0, 2).trimRight(),
          ordenEstadoCivil: _EstadosCiviles2.map((e) => e.Orden).first,
          estadoCivil: estadoCivil.toString().trimLeft(),
          claveParentesco: _parentesco2.text.substring(0, 2),
          ordenParentesco: _Parentesco2.map((e) => e.Orden).first,
          parentesco: parentesco.toString().trimLeft(),
          otroEstadoCivil: _otroEstadoCivil2.text.toString(),
          otroParentesco: _otroParentesco2.text.toString(),
          dispositivo: widget.dispositivo,
          folioDisp: widget.folioDisp,
          usuario: widget.usuario,
          orden: '1');
  ...
  renglon3() async {
    if (_nombre3.text != '') {
      ...
      await metodos(
          _entidadNacimiento3.text, _estadoCivil3.text, _parentesco3.text);

      var EstadoCivil = _estadoCivil3.text.toString();
      final estadoCivil = rpn.replaceNum(EstadoCivil);
      var Parentesco = _parentesco3.text.toString();
      final parentesco = rpn.replaceNum(Parentesco);
      var EntidadN = _entidadNacimiento3.text.toString();
      final entidadNacimiento = rpn.replaceNum(EntidadN);
      ...
      EstructuraFamilarModel ef = EstructuraFamilarModel(
          ...
          claveEntidad: _entidadNacimiento3.text.substring(0, 2).trimRight(),
          entidadNacimiento: entidadNacimiento.toString().trimLeft(),
          curp: _curp3.text.toString(),
          claveEstadoCivil: _estadoCivil3.text.substring(0, 2).trimRight(),
          ordenEstadoCivil: _EstadosCiviles2.map((e) => e.Orden).first,
          estadoCivil: estadoCivil.toString().trimLeft(),
          claveParentesco: _parentesco3.text.substring(0, 2),
          ordenParentesco: _Parentesco2.map((e) => e.Orden).first,
          parentesco: parentesco.toString().trimLeft(),
          otroEstadoCivil: _otroEstadoCivil3.text.toString(),
          otroParentesco: _otroParentesco3.text.toString(),
          dispositivo: widget.dispositivo,
          folioDisp: widget.folioDisp,
          usuario: widget.usuario,
          orden: '2');
  ...
  renglon4() async {
    if (_nombre4.text != '') {
      ...
      await metodos(
          _entidadNacimiento4.text, _estadoCivil4.text, _parentesco4.text);

      var EstadoCivil = _estadoCivil4.text.toString();
      final estadoCivil = rpn.replaceNum(EstadoCivil);
      var Parentesco = _parentesco4.text.toString();
      final parentesco = rpn.replaceNum(Parentesco);
      var EntidadN = _entidadNacimiento4.text.toString();
      final entidadNacimiento = rpn.replaceNum(EntidadN);
      ...
      EstructuraFamilarModel ef = EstructuraFamilarModel(
          ...
          claveEntidad: _entidadNacimiento4.text.substring(0, 2).trimRight(),
          entidadNacimiento: entidadNacimiento.toString().trimLeft(),
          curp: _curp4.text.toString(),
          claveEstadoCivil: _estadoCivil4.text.substring(0, 2).trimRight(),
          ordenEstadoCivil: _EstadosCiviles2.map((e) => e.Orden).first,
          estadoCivil: estadoCivil.toString().trimLeft(),
          claveParentesco: _parentesco4.text.substring(0, 2),
          ordenParentesco: _Parentesco2.map((e) => e.Orden).first,
          parentesco: parentesco.toString().trimLeft(),
          otroEstadoCivil: _otroEstadoCivil4.text.toString(),
          otroParentesco: _otroParentesco4.text.toString(),
          dispositivo: widget.dispositivo,
          folioDisp: widget.folioDisp,
          usuario: widget.usuario,
          orden: '3');
  ...
  renglon5() async {
    if (_nombre5.text != '') {
      ...
      await metodos(
          _entidadNacimiento5.text, _estadoCivil5.text, _parentesco5.text);

      var EstadoCivil = _estadoCivil5.text.toString();
      final estadoCivil = rpn.replaceNum(EstadoCivil);
      var Parentesco = _parentesco5.text.toString();
      final parentesco = rpn.replaceNum(Parentesco);
      var EntidadN = _entidadNacimiento5.text.toString();
      final entidadNacimiento = rpn.replaceNum(EntidadN);
      ...
      EstructuraFamilarModel ef = EstructuraFamilarModel(
          ...
          claveEntidad: _entidadNacimiento5.text.substring(0, 2).trimRight(),
          entidadNacimiento: entidadNacimiento.toString().trimLeft(),
          curp: _curp5.text.toString(),
          claveEstadoCivil: _estadoCivil5.text.substring(0, 2).trimRight(),
          ordenEstadoCivil: _EstadosCiviles2.map((e) => e.Orden).first,
          estadoCivil: estadoCivil.toString().trimLeft(),
          claveParentesco: _parentesco5.text.substring(0, 2),
          ordenParentesco: _Parentesco2.map((e) => e.Orden).first,
          parentesco: parentesco.toString().trimLeft(),
          otroEstadoCivil: _otroEstadoCivil5.text.toString(),
          otroParentesco: _otroParentesco5.text.toString(),
          dispositivo: widget.dispositivo,
          folioDisp: widget.folioDisp,
          usuario: widget.usuario,
          orden: '4');
  ...
  renglon6() async {
    if (_nombre6.text != '') {
      ...
      await metodos(
          _entidadNacimiento6.text, _estadoCivil6.text, _parentesco6.text);

      var EstadoCivil = _estadoCivil6.text.toString();
      final estadoCivil = rpn.replaceNum(EstadoCivil);
      var Parentesco = _parentesco6.text.toString();
      final parentesco = rpn.replaceNum(Parentesco);
      var EntidadN = _entidadNacimiento6.text.toString();
      final entidadNacimiento = rpn.replaceNum(EntidadN);
      ...
      EstructuraFamilarModel ef = EstructuraFamilarModel(
          ...
          claveEntidad: _entidadNacimiento6.text.substring(0, 2).trimRight(),
          entidadNacimiento: entidadNacimiento.toString().trimLeft(),
          curp: _curp6.text.toString(),
          claveEstadoCivil: _estadoCivil6.text.substring(0, 2).trimRight(),
          ordenEstadoCivil: _EstadosCiviles2.map((e) => e.Orden).first,
          estadoCivil: estadoCivil.toString().trimLeft(),
          claveParentesco: _parentesco6.text.substring(0, 2),
          ordenParentesco: _Parentesco2.map((e) => e.Orden).first,
          parentesco: parentesco.toString().trimLeft(),
          otroEstadoCivil: _otroEstadoCivil6.text.toString(),
          otroParentesco: _otroParentesco6.text.toString(),
          dispositivo: widget.dispositivo,
          folioDisp: widget.folioDisp,
          usuario: widget.usuario,
          orden: '5');
  ...
  renglon7() async {
    if (_nombre7.text != '') {
      ...
      await metodos(
          _entidadNacimiento7.text, _estadoCivil7.text, _parentesco7.text);

      var EstadoCivil = _estadoCivil7.text.toString();
      final estadoCivil = rpn.replaceNum(EstadoCivil);
      var Parentesco = _parentesco7.text.toString();
      final parentesco = rpn.replaceNum(Parentesco);
      var EntidadN = _entidadNacimiento7.text.toString();
      final entidadNacimiento = rpn.replaceNum(EntidadN);
      ...
      EstructuraFamilarModel ef = EstructuraFamilarModel(
          ...
          claveEntidad: _entidadNacimiento7.text.substring(0, 2).trimRight(),
          entidadNacimiento: entidadNacimiento.toString().trimLeft(),
          curp: _curp7.text.toString(),
          claveEstadoCivil: _estadoCivil7.text.substring(0, 2).trimRight(),
          ordenEstadoCivil: _EstadosCiviles2.map((e) => e.Orden).first,
          estadoCivil: estadoCivil.toString().trimLeft(),
          claveParentesco: _parentesco7.text.substring(0, 2),
          ordenParentesco: _Parentesco2.map((e) => e.Orden).first,
          parentesco: parentesco.toString().trimLeft(),
          otroEstadoCivil: _otroEstadoCivil7.text.toString(),
          otroParentesco: _otroParentesco7.text.toString(),
          dispositivo: widget.dispositivo,
          folioDisp: widget.folioDisp,
          usuario: widget.usuario,
          orden: '6');
  ...
  renglon8() async {
    if (_nombre8.text != '') {
      ...
      await metodos(
          _entidadNacimiento8.text, _estadoCivil8.text, _parentesco8.text);

      var EstadoCivil = _estadoCivil8.text.toString();
      final estadoCivil = rpn.replaceNum(EstadoCivil);
      var Parentesco = _parentesco8.text.toString();
      final parentesco = rpn.replaceNum(Parentesco);
      var EntidadN = _entidadNacimiento8.text.toString();
      final entidadNacimiento = rpn.replaceNum(EntidadN);
      ...
      EstructuraFamilarModel ef = EstructuraFamilarModel(
          ...
          claveEntidad: _entidadNacimiento8.text.substring(0, 2).trimRight(),
          entidadNacimiento: entidadNacimiento.toString().trimLeft(),
          curp: _curp8.text.toString(),
          claveEstadoCivil: _estadoCivil8.text.substring(0, 2).trimRight(),
          ordenEstadoCivil: _EstadosCiviles2.map((e) => e.Orden).first,
          estadoCivil: estadoCivil.toString().trimLeft(),
          claveParentesco: _parentesco8.text.substring(0, 2),
          ordenParentesco: _Parentesco2.map((e) => e.Orden).first,
          parentesco: parentesco.toString().trimLeft(),
          otroEstadoCivil: _otroEstadoCivil8.text.toString(),
          otroParentesco: _otroParentesco8.text.toString(),
          dispositivo: widget.dispositivo,
          folioDisp: widget.folioDisp,
          usuario: widget.usuario,
          orden: '7');
  ...
  renglon9() async {
    if (_nombre9.text != '') {
      ...
      await metodos(
          _entidadNacimiento9.text, _estadoCivil9.text, _parentesco9.text);

      var EstadoCivil = _estadoCivil9.text.toString();
      final estadoCivil = rpn.replaceNum(EstadoCivil);
      var Parentesco = _parentesco9.text.toString();
      final parentesco = rpn.replaceNum(Parentesco);
      var EntidadN = _entidadNacimiento9.text.toString();
      final entidadNacimiento = rpn.replaceNum(EntidadN);
      ...
      EstructuraFamilarModel ef = EstructuraFamilarModel(
          ...
          claveEntidad: _entidadNacimiento9.text.substring(0, 2).trimRight(),
          entidadNacimiento: entidadNacimiento.toString().trimLeft(),
          curp: _curp9.text.toString(),
          claveEstadoCivil: _estadoCivil9.text.substring(0, 2).trimRight(),
          ordenEstadoCivil: _EstadosCiviles2.map((e) => e.Orden).first,
          estadoCivil: estadoCivil.toString().trimLeft(),
          claveParentesco: _parentesco9.text.substring(0, 2),
          ordenParentesco: _Parentesco2.map((e) => e.Orden).first,
          parentesco: parentesco.toString().trimLeft(),
          otroEstadoCivil: _otroEstadoCivil9.text.toString(),
          otroParentesco: _otroParentesco9.text.toString(),
          dispositivo: widget.dispositivo,
          folioDisp: widget.folioDisp,
          usuario: widget.usuario,
          orden: '8');
  ...
  renglon10() async {
    if (_nombre10.text != '') {
      ...
      await metodos(
          _entidadNacimiento10.text, _estadoCivil10.text, _parentesco10.text);

      var EstadoCivil = _estadoCivil10.text.toString();
      final estadoCivil = rpn.replaceNum(EstadoCivil);
      var Parentesco = _parentesco10.text.toString();
      final parentesco = rpn.replaceNum(Parentesco);
      var EntidadN = _entidadNacimiento10.text.toString();
      final entidadNacimiento = rpn.replaceNum(EntidadN);
      ...
      EstructuraFamilarModel ef = EstructuraFamilarModel(
          ...
          claveEntidad: _entidadNacimiento10.text.substring(0, 2).trimRight(),
          entidadNacimiento: entidadNacimiento.toString().trimLeft(),
          curp: _curp10.text.toString(),
          claveEstadoCivil: _estadoCivil10.text.substring(0, 2).trimRight(),
          ordenEstadoCivil: _EstadosCiviles2.map((e) => e.Orden).first,
          estadoCivil: estadoCivil.toString().trimLeft(),
          claveParentesco: _parentesco10.text.substring(0, 2),
          ordenParentesco: _Parentesco2.map((e) => e.Orden).first,
          parentesco: parentesco.toString().trimLeft(),
          otroEstadoCivil: _otroEstadoCivil10.text.toString(),
          otroParentesco: _otroParentesco10.text.toString(),
          dispositivo: widget.dispositivo,
          folioDisp: widget.folioDisp,
          usuario: widget.usuario,
          orden: '9');
  ...
  guardar() async {
    ...
    try {
      ...
      print(error);
      print(_EstructuraGuardar[0].toString());
        ...
        builder: (context) => AlertDialog(
              ...
              actions: [
                TextButton(
                    ...
                    child: Text('Revisar')),
                TextButton(onPressed: actualizar, child: Text('Actualizar'))
              ],
            ));
  }
}
